...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { address: @detail.address, contact_number: @detail.contact_number, first_name: @detail.first_name, last_name: @detail.last_name, organization: @detail.organization } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { address: @detail.address, contact_number: @detail.contact_number, first_name: @detail.first_name, last_name: @detail.last_name, organization: @detail.organization } }
